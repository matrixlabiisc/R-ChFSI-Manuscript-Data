## Total eigensolve speedup bar chart (complex GEP).
...
plot "perfTotBCCMo.dat" using 2:xtic(1) fillstyle pattern 2 fillcolor rgb "#d62728" title "FP32" , \
...
plot "perfTotSi.dat" using 2:xtic(1) fillstyle pattern 2 fillcolor rgb "#d62728" title "FP32" , \
     "" using 3 fillstyle pattern 2 fillcolor rgb "#1f77b4" title "TF32", \
     "" using 4 fillstyle pattern 2 fillcolor rgb "#ff7f0e" title "TF32B"
set format y ''
unset ylabel
set title "m=85766121\n n=13500 \n 100 nodes Aurora" offset -10,-4.1
plot "perfTotC.dat" using 2:xtic(1) fillstyle pattern 2 fillcolor rgb "#d62728" title "FP32" , \
     "" using 3 fillstyle pattern 2 fillcolor rgb "#1f77b4" title "TF32", \
     "" using 4 fillstyle pattern 2 fillcolor rgb "#ff7f0e" title "TF32B"
unset multiplot
unset output
